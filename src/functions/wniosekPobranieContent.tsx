...
/**
 * Funkcja generująca content dla PDF, przyjmująca argumenty (np. numer, data).
 * Dzięki temu masz pełną elastyczność.
 */

export function getWniosekContent(): Content {
  return [
    // Nagłówek na środku
    {
...
export const wniosekStyles: StyleDictionary = {
    header: {
